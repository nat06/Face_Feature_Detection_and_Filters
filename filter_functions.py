...
def devil_horns_filter(frame, landmarks) :
    ...
    horns_area = frame[ up_center[1] : up_center[1] + horns_height, up_center[0] : up_center[0] + horns_width]
    ...
    frame[up_center[1] : up_center[1] + horns_height, up_center[0] : up_center[0] + horns_width] = final_frame

    return frame

def diadelosmuertos_filter(frame, landmarks) :
    ...
    paint_area = frame[ up_center[1] : up_center[1] + paint_height, up_center[0] : up_center[0] + paint_width]
    ...
    frame[up_center[1] : up_center[1] + paint_height, up_center[0] : up_center[0] + paint_width] = final_frame

    return frame

def tears_filter(frame, landmarks) :
    ...
    tears_area = frame[ up_center[1] : up_center[1] + tears_height, up_center[0] : up_center[0] + tears_width]
    ...
    frame[up_center[1] : up_center[1] + tears_height, up_center[0] : up_center[0] + tears_width] = final_frame

    return frame

def glasses_filter(frame, landmarks) :
